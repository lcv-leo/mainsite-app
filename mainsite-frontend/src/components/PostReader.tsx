  ...
  return (
    <article aria-label={post.title}>
      <style>{`
        ...
        .html-content h2 { color: ${activePalette.titleColor}; margin: 2.5rem 0 1rem 0; font-weight: ${settings.shared.titleWeight || '700'}; font-size: calc(1.75rem * var(--text-zoom-scale, 1)); letter-spacing: -0.01em; line-height: 1.25; transition: font-size 0.2s cubic-bezier(0.4, 0, 0.2, 1), color 0.5s ease; }
        .html-content h3 { color: ${activePalette.titleColor}; margin: 2rem 0 0.8rem 0; font-weight: ${Math.max(400, (parseInt(settings.shared.titleWeight) || 700) - 100)}; font-size: calc(1.4rem * var(--text-zoom-scale, 1)); letter-spacing: -0.01em; line-height: 1.3; transition: font-size 0.2s cubic-bezier(0.4, 0, 0.2, 1), color 0.5s ease; }
        .html-content h4 { color: ${activePalette.titleColor}; margin: 1.8rem 0 0.7rem 0; font-weight: ${Math.max(400, (parseInt(settings.shared.titleWeight) || 700) - 200)}; font-size: calc(1.15rem * var(--text-zoom-scale, 1)); line-height: 1.35; transition: font-size 0.2s cubic-bezier(0.4, 0, 0.2, 1), color 0.5s ease; }
        .html-content h5 { color: ${activePalette.titleColor}; margin: 1.5rem 0 0.6rem 0; font-weight: ${Math.max(400, (parseInt(settings.shared.titleWeight) || 700) - 200)}; font-size: calc(0.95rem * var(--text-zoom-scale, 1)); text-transform: uppercase; letter-spacing: 0.06em; line-height: 1.4; transition: font-size 0.2s cubic-bezier(0.4, 0, 0.2, 1), color 0.5s ease; }
